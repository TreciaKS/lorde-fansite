...
const AboutContent = ({ abouts }: Props): ReactElement => {
  return (
    <section className="mx-2 my-5 tracking-wide">
      <div className="grid h-screen grid-rows-3 gap-3 text-black lg:grid-cols-4 md:grid-cols-2">
        <article className="grid overflow-y-auto shadow-md rounded-2xl place-items-center lg:row-span-3 md:row-span-1 bg-melo-night-blue shadow-melo-night-blue">
          <div className="px-1 py-10 mx-auto">
            <h1 className="text-2xl text-center capitalize text-pure-white lg:text-3xl">
            ...
            <div className="flex items-start max-w-6xl mx-auto mt-16 max-md:mx-5">
              <div>
                <div className="text-center text-pure-white lg:mx-6">
                  <h1 className="mb-3 -mt-5 text-2xl font-semibold capitalize text-solar-sea-blue">
        ...
        <article className="pt-12 overflow-y-scroll shadow-md rounded-xl bg-pure-black lg:col-span-2 lg:row-span-2 md:row-span-3 shadow-pure-black">
        ...
        <div className="grid object-contain w-full overflow-hidden border-4 shadow-md rounded-2xl lg:row-span-2 place-items-center max-md:hidden border-solar-mustard shadow-solar-mustard">
          <img
        ...
        <article className="relative object-contain overflow-hidden border-4 rounded-lg shadow-md lg:col-start-2 lg:col-span-3 lg:row-start-3 shadow-melo-sky-blue">
          <iframe
